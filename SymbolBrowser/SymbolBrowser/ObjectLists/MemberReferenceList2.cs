...
{
    public class MemberReferenceList2 : NodeReferenceList2
    {
        public MemberReferenceList2(string text, string fName, string preffix, int lineNumber, int columnNumber)
