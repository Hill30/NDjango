...
namespace NDjango.UnitTests
{
    public partial class Tests
    {
        ...
        public IList<TestDescriptor> GetPluralizeFilters()
        {
        ...
        public IList<TestDescriptor> GetPhone2NumericFilters()
        {
            IList<TestDescriptor> lst = new List<TestDescriptor>();
        ...
        public IList<TestDescriptor> GetDefaultIfNoneFilters()
        {
            IList<TestDescriptor> lst = new List<TestDescriptor>();
...
//            lst.Add(new TestDescriptor("default_if_none-filter02", "{{value|default_if_none:'default'}}", ContextObjects.p("value", null), ContextObjects.p("default")));
        ...
        public IList<TestDescriptor> GetFileSizeFormatFilters()
        {
            IList<TestDescriptor> lst = new List<TestDescriptor>();
