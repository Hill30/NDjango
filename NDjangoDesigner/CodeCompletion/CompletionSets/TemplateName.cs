...
namespace NDjango.Designer.CodeCompletion.CompletionSets
{
    class TemplateName: AbstractCompletionSet
    {
        ...
        void Session_Committed(object sender, EventArgs e)
        {
            ...
            Node.Provider.Broker.TemplateManager.RegisterInserted(inserted);
        }
        ...
        {
            return BuildCompletions(Node.Provider.Broker.TemplateManager.GetTemplates(null), quote_char.ToString(), quote_char.ToString());
        }

        protected override IEnumerable<Completion> BuildNodeCompletionBuilders()
        {
            return BuildCompletions(Node.Provider.Broker.TemplateManager.Recent5Templates, quote_char.ToString(), quote_char.ToString());
        }
    }
}
